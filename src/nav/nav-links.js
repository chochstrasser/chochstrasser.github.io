  ...
  return (
    <div className="código-animate-top código-card-4 código-white">
      <div>
        ...
        />
        <NavLink
          onClick={onClick(ROUTES.problems.zigzag)}
        ...
        />
        <NavLink
          onClick={onClick(ROUTES.problems.flatten)}
          isActive={pathname === ROUTES.problems.flatten}
          text="Flatten"
        />
        <NavLink
          onClick={onClick(ROUTES.problems.floodFill)}
          isActive={pathname === ROUTES.problems.floodFill}
          text="Flood Fill"
        />
        <h4 className="código-center">Game</h4>
        <NavLink
          onClick={onClick(ROUTES.games["tic-tac-toe"])}
